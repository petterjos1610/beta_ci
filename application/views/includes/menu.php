			...
			<div class="clearfix"></div>
				...
				<?php }
					...
					<li><a class="menu_grey <?php if ($colour == "grey") echo "current_tab"; ?>" style="cursor:pointer;"><span><i class="fa fa-cog"></i></span>Type Setting</a>
						<ul class="grey-ul">
							<?php if (in_array(Page::$tkt[0],$this->client->getPrivileges())) { ?><li><a href="<?php echo base_url(); ?>index.php/tickettopics/view/<?php echo md5(Page::$tkt[0]); ?>">Ticket Topics</a></li><?php } ?>
							...
							<?php if (in_array(Page::$stp[0],$this->client->getPrivileges())) { ?><li><a href="<?php echo base_url(); ?>index.php/studenttypes/view/<?php echo md5(Page::$stp[0]); ?>">Student Types</a></li><?php } ?>
							<?php if (in_array(Page::$eth[0],$this->client->getPrivileges())) { ?><li><a href="<?php echo base_url(); ?>index.php/ethnicities/view/<?php echo md5(Page::$eth[0]); ?>">Ethnicities</a></li><?php } ?>
							...
							<?php if (in_array(Page::$cbt[0],$this->client->getPrivileges())) { ?><li><a href="<?php echo base_url(); ?>index.php/cities/view/<?php echo md5(Page::$cbt[0]); ?>">Cities/Boroughs</a></li><?php } ?>
								<li><a href="<?php echo base_url(); ?>index.php/religions/view/<?php echo md5(Page::$rel[0]); ?>">Religions</a></li>
